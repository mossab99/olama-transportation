    ...
    <div class="olama-tab-content">
        ...
        <?php if ($active_tab === 'reports'): ?>
            <div id="olama-school-reports" class="olama-card">
                ...
                <div id="school-report-feedback" class="olama-operation-result" aria-live="polite"></div><div id="school-report-results"></div><div id="family-report-controls" hidden><label>Family ID or name <input type="search" id="family-report-search"></label><button type="button" class="button" id="family-report-search-button">Search</button><button type="button" class="button" id="family-report-print">Print report</button></div><div id="family-report-results"></div><div id="unassigned-report-results" hidden></div><button type="button" class="button" id="unassigned-report-print" hidden>Print report</button>
            </div>
        <?php endif; ?>
