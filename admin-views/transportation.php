    ...
    <div class="olama-tab-content">
        ...
        <?php if ($active_tab === 'reports'): ?>
            <div id="olama-school-reports" class="olama-card">
                ...
                <div class="olama-transportation-toolbar"><div><h2><?php echo esc_html($translate('School-level transportation report')); ?></h2><p class="description"><?php echo esc_html($translate('Select filters to view student transportation details, including students without transportation.')); ?></p></div></div>
