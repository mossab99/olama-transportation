    ...
    <div class="olama-tab-content">
        ...
        <?php if ($active_tab === 'reports'): ?>
            <div id="olama-school-reports" class="olama-card">
                <div class="reports-block-grid"><button type="button" class="button reports-block is-active" data-report-type="school"><strong><?php echo esc_html($translate('Transportation students')); ?></strong><span><?php echo esc_html($translate('Subscribed students and their direction-specific trip status.')); ?></span></button><button type="button" class="button reports-block" data-report-type="walking"><strong><?php echo esc_html($translate('Walking students')); ?></strong><span><?php echo esc_html($translate('Academically registered students without an active transportation subscription.')); ?></span></button><button type="button" class="button reports-block" data-report-type="family"><strong><?php echo esc_html($translate('Family search')); ?></strong><span><?php echo esc_html($translate('Search every registered or subscribed student and review both directions.')); ?></span></button><button type="button" class="button reports-block" data-report-type="unassigned"><strong><?php echo esc_html($translate('Assignment gaps')); ?></strong><span><?php echo esc_html($translate('Subscribed students missing arrival, departure, or both assignments.')); ?></span></button></div>
