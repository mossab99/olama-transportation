    ...
    <div class="olama-tab-content">
        ...
        <?php if ($active_tab === 'reports'): ?>
            <div id="olama-school-reports" class="olama-card">
                <div class="reports-block-grid"><button type="button" class="button reports-block is-active" data-report-type="school"><strong>Transportation students</strong><span>Subscribed students and their direction-specific trip status.</span></button><button type="button" class="button reports-block" data-report-type="walking"><strong>Walking students</strong><span>Academically registered students without an active transportation subscription.</span></button><button type="button" class="button reports-block" data-report-type="family"><strong>Family search</strong><span>Search every registered or subscribed student and review both directions.</span></button><button type="button" class="button reports-block" data-report-type="unassigned"><strong>Assignment gaps</strong><span>Subscribed students missing arrival, departure, or both assignments.</span></button></div>
                <div class="olama-area-filters"><label>Report type<select id="school-report-type"><option value="school">Transportation students</option><option value="walking">Walking students</option><option value="family">Family search</option><option value="unassigned">Assignment gaps</option></select></label></div>
                ...
                <section id="unassigned-report-panel" hidden><div class="olama-area-filters"><label>Academic Year <select id="unassigned-report-year"><?php foreach ($years as $year): ?><option value="<?php echo intval($year->id); ?>" <?php selected($selected_year_id,$year->id); ?>><?php echo esc_html($year->year_name); ?></option><?php endforeach; ?></select></label><label>Gap scope <select id="unassigned-report-scope"><option value="any_missing">Missing arrival or departure</option><option value="morning">Missing arrival</option><option value="afternoon">Missing departure</option><option value="none">No trip in either direction</option></select></label><button type="button" class="button" id="unassigned-report-print">Print report</button></div><div id="unassigned-report-results"></div></section>
            </div>
        <?php endif; ?>
