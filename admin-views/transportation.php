    ...
    <div class="olama-tab-content">
        ...
        <?php if ($active_tab === 'areas'): ?>
            <div id="olama-areas-workspace" class="olama-card" data-year-id="<?php echo intval($selected_year_id); ?>">
                ...
                <details class="olama-area-demand-panel" open><summary><?php echo esc_html($translate('Area demand and assignments')); ?></summary><div class="olama-area-table-wrap"><table class="wp-list-table widefat striped olama-area-table"><thead><tr><th><?php echo esc_html($translate('Oracle Area')); ?></th><th><?php echo esc_html($translate('Student Coverage')); ?></th><th><?php echo esc_html($translate('Assigned Trips')); ?></th><th><?php echo esc_html($translate('Display Settings')); ?></th></tr></thead><tbody id="areas-body"><tr><td colspan="4"><?php echo esc_html($translate('Loading...')); ?></td></tr></tbody></table></div></details>
